...
const Banner = () => {
    return (
        <div className='bg-[#F1F2F4] pt-22 lg:pt-44'>
            ...
            <p className='px-2 text-[1rem] lg:text-[1.125rem] max-w-[33.5rem] text-[#18191C] py-3'>Aliquam vitae turpis in diam convallis finibus in at risus. Nullam in scelerisque leo, eget sollicitudin velit bestibulum.</p>
            <div className='px-2'>
