            ...
            <div className=''>
                ...
                <div className='flex  max-w-7xl mx-auto flex-wrap md:flex-nowrap justify-between items-center bg-white p-3 rounded-md shadow-md gap-4'>
                    <div className='flex gap-3 items-center '>
                        ...
                        <Input type='text' placeholder='Job title, Keyword...' className='border-none shadow-none outline-none' />
                    </div>
                    <div className='flex gap-3 items-center '>
                        <SlLocationPin className='text-blue-500 text-2xl' />
                        <Input type='text' placeholder='Your Location' className='border-none shadow-none outline-none' />
                    </div>
                    <Select>
                    ...
                    <Button className='bg-[#0A65CC] h-[3rem] w-[8rem] hover:bg-[#0A65CC] cursor-pointer'>Find Job</Button>
                </div>
                </div>
